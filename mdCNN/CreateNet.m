...
function [ net ] = CreateNet( conf_file )
     ...
     net.runInfoParam.imagesLearned=0;
...
function [ net ] = initNetDefaults( net )
     ...
     net.hyperParam.addBackround=0; % random background can be added to images before passing to net in order to improve noise resistance.
